...
func (c *chartsClient) GetEaParams(ctx context.Context, in *GetEaParamsRequest, opts ...grpc.CallOption) (*GetEaParamsReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mt4_term_api.Charts/GetEaParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsClient) OpenTerminalChartWithEa(ctx context.Context, in *OpenTerminalChartWithEaRequest, opts ...grpc.CallOption) (*OpenTerminalChartWithEaReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mt4_term_api.Charts/OpenTerminalChartWithEa", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsClient) AttachEa(ctx context.Context, in *AttachEaRequest, opts ...grpc.CallOption) (*AttachEaReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mt4_term_api.Charts/AttachEa", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsClient) GetRunningEas(ctx context.Context, in *GetRunningEasRequest, opts ...grpc.CallOption) (*GetRunningEasReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mt4_term_api.Charts/GetRunningEas", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsClient) GetEaLogs(ctx context.Context, in *GetEaLogsRequest, opts ...grpc.CallOption) (*GetEaLogsReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mt4_term_api.Charts/GetEaLogs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsClient) StopEa(ctx context.Context, in *StopEaRequest, opts ...grpc.CallOption) (*StopEaReply, error) {
	out := new(StopEaReply)
	err := c.cc.Invoke(ctx, "/mt4_term_api.Charts/StopEa", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chartsClient) StartEa(ctx context.Context, in *StartEaRequest, opts ...grpc.CallOption) (*StartEaReply, error) {
	...
	err := c.cc.Invoke(ctx, "/mt4_term_api.Charts/StartEa", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Charts_GetEaParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mt4_term_api.Charts/GetEaParams",
	}
...
func _Charts_OpenTerminalChartWithEa_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mt4_term_api.Charts/OpenTerminalChartWithEa",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Charts_AttachEa_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mt4_term_api.Charts/AttachEa",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Charts_GetRunningEas_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mt4_term_api.Charts/GetRunningEas",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Charts_GetEaLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mt4_term_api.Charts/GetEaLogs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Charts_StopEa_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mt4_term_api.Charts/StopEa",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Charts_StartEa_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mt4_term_api.Charts/StartEa",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
